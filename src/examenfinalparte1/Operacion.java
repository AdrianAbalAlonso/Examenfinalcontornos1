...
public class Operacion {
    ...
    /**
     * Constructor que recibe por parametros un valor que se lo aplica al método
     * suma para sumarse asi mismo
     *
     * @param numero1 variable que almacena el numero que se quiere sumar a si
     * mismo.
     */
    ...
    /**
     * Constructor vacio que no recibe ninguna variable y no devuelve nada, lo
     * unico que hace es asignarle a la variable result el valor -1
     */
    public Operacion() {
        resultadoSum = -1;
    }
